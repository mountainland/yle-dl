...
def test_radio_title_hls():
    ...
    t = title[0]
    assert t.startswith(
        "Tiedeykkönen Extra: Ilmastonmuutos: Ihminen elää ilman vettä vain muutaman päivän"
    ) or t.startswith(
        "Ilmastonmuutoksen vaikutukset: Ihminen elää ilman vettä vain muutaman päivän"
    )
