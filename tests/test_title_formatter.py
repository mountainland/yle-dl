...
def pasila():
    return {
        ...
        "publish_timestamp": datetime(2018, 4, 12, 16, 30, 45, tzinfo=FixedOffset(2)),
        "series_title": "Pasila",
...
def test_all_components(pasila):
    assert (
        tf.format(**pasila) == "Pasila: Vanhempainyhdistys: "
...
def test_template(pasila):
    ...
    assert (
        fmt.format(**pasila) == "Pasila: Vanhempainyhdistys: "
        "tekstitys englanniksi: S01E03-2018-04-12T16:30"
    )
